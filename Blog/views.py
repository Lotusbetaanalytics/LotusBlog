...
class CommentListCreateView(ListCreateAPIView):
    ...
    def get_queryset(self):
        queryset = Comment.objects.all()
        blog = BlogPost.objects.get(id=self.kwargs['blog_id'])
        print(self.kwargs)
        if blog:
            queryset = Comment.objects.filter(blog=self.kwargs['blog_id'])
        return queryset
    ...
    #     comments_ = []
    #     comment_objects = Comment.objects.filter(blog=kwargs['blog_id'])
    #     for comment in comment_objects:
    #         data = {
    #             "id": comment.id,
    #             "name": comment.name,
